...
const append_members = () => {
  add_member("jasinski.jpg", "Mechanical leader", "Jacek Jasiński", "row_0");
  ...
  add_member("anonymous.png", "Vice leader", "Aleksandra Jarysz", "row_0");
  add_member(
    "penczynska.jpg",
    "Promotion member",
    "Natalia Penczyńska",
  ...
  add_member("anonymous.png", "Promotion member", "Aleksandra Jarysz", "row_1");
  ...
  add_member("anonymous.png", "Promotion member", "Julita Dominiak", "row_2");
  add_member("anonymous.png", "Promotion member", "Filip Staszak", "row_2");
  ...
  add_member("lebioda.jpg", "Suspension member", "Maciej Lebioda", "row_4");
  add_member("golec.jpg", "Suspension member", "Łukasz Golec", "row_4");
  add_member("anonymous.png", "Suspension member", "Olaf Młodak", "row_5");
  ...
  add_member("wisniewski.jpg", "Electric member", "Marcin Wiśniewski", "row_8");
  ...
  add_member("stasik.jpg", "Electronics member", "Igor Stasik", "row_10");
